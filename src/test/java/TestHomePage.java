import ru.praktikum.services.qa.scooter.pageobject.HomePage;
...
public class TestHomePage {
    ...
    private int number;
    public TestHomePage(String expected, int number) {
        this.expected = expected;
        this.number = number;
    }
    @Parameterized.Parameters
    public static Object[][] getAnswersParamList() {
        return new Object[][]{
    ...
    @Test
    public void checkClickQuestion() {
        driver = new ChromeDriver();
        HomePage object = new HomePage(driver);
        driver.get("https://qa-scooter.praktikum-services.ru/");
        object.clickButtonCookie();
        object.clickListQuestion(number);
        String actual = object.getTextOfListAnswer(number);
        Assert.assertEquals("Текст не соответствует тексту выпадающего списка", expected, actual);
    }
    @After
